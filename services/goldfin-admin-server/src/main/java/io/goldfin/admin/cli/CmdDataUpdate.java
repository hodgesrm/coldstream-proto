...
public class CmdDataUpdate implements Command {
	static final Logger logger = LoggerFactory.getLogger(CmdDataUpdate.class);
	private OptionParser parser = new OptionParser();

	public CmdDataUpdate() {
	...
	public void exec(CliContext ctx) {
		...
		try {
			client.update(String.format("/data/%s", id), docParams);
