...
// Subclassed DataSeries API to implement form-based data series loading. 
@Injectable()
export class DataSeriesApiExtended extends InventoryApi {
    ...
    /**
     * Upload data series.  This is tweaked to generate binary form data 
