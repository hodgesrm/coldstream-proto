...
export namespace Host {
    export type HostTypeEnum = 'BARE_METAL' | 'CLOUD' | 'UNKNOWN';
    export const HostTypeEnum = {
        BAREMETAL: 'BARE_METAL' as HostTypeEnum,
        CLOUD: 'CLOUD' as HostTypeEnum,
        UNKNOWN: 'UNKNOWN' as HostTypeEnum
    }
}
