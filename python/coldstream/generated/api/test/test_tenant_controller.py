...
class TestTenantController(BaseTestCase):
    ...
    def test_tenant_create(self):
        ...
        Create a new tenant
        """
        body = TenantRegistrationParameters()
    ...
    def test_user_create(self):
        ...
        """
        body = UserParameters()
        response = self.client.open('/api/v1/tenant/{tenantId}/user'.format(tenantId='tenantId_example'),
                                    method='POST',
                                    data=json.dumps(body),
                                    content_type='application/json')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
    ...
    def test_user_delete(self):
        ...
        Delete a user
        """
        response = self.client.open('/api/v1/tenant/{tenantId}/user/{id}'.format(tenantId='tenantId_example', id='id_example'),
                                    method='DELETE')
        self.assert200(response, "Response body is : " + response.data.decode('utf-8'))
